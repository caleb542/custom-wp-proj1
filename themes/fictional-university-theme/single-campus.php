<?php
  ...
  while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
      ...
      <div class="acf-map" style="box-sizing:border-box; display:grid; place-content:center; background-color:forestgreen;text-shadow:0 0 10px #fff;">
        <h3>Google Map</h3>
        <p><em>Sorry, the Google Map is unavailable</em></p>
